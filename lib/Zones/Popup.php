...
class MASE_Zones_Popup {
    public static function init() {
        if(is_admin()) add_action('wp_ajax_mase_popup_zone', array('MASE_Zones_Popup', 'wp_ajax_mase_popup_zone'));
        if(is_admin()) add_action('wp_ajax_mase_popup_zone_save', array('MASE_Zones_Popup', 'wp_ajax_mase_popup_zone_save'));
    }

    public static function wp_ajax_mase_popup_zone() {
        ...
        $widget_data = get_option('widget_'.strtolower('MASE_Popup_Widget'));
        $selected_widget = isset($widget_data[$widget_number]) ? $widget_data[$widget_number] : false;
        $zone_identifier = MASE_PREFIX.'popup_zone_ads_'.$widget_number;
        ...
        <form class="mase_zone_configurator_form">
            <input type="hidden" name="save_action" value="mase_popup_zone_save" />
    ...
    public static function wp_ajax_mase_popup_zone_save() {
        if(!isset($_REQUEST['widget_number'])) { die(); }
        $zone_identifier = MASE_PREFIX.'popup_zone_ads_'.(int)$_REQUEST['widget_number'];
